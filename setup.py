...
tf_version = "2.12"  # Default Version
try:
...
compatible_tfp = {"2.12": ["tensorflow-probability~=0.19.0"],
                  "2.7": ["tensorflow-probability~=0.15.0"],
...
compatible_tfa = {"2.12": ["tensorflow_addons~=0.20.0"],
...
extras_require = {
    ...
    "test": ["coveralls", "opencv-python", "future"]
}
