...
class FTActor(tf.keras.Model):
    ...
    def __init__(self, state_shape, action_dim, max_action,
        ...
        self.x_l2 = Dense(units[1], name="x_L2", activation=hidden_activation)

        self.ft_l1 = Dense(units[0], name="ft_L1", activation=hidden_activation)
    ...
    def _compute_dist(self, states):
        ...
        ft_features = self.ft_l1(states[:, 26:])
